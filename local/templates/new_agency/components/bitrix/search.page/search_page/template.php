...
//debug(count($arResult["SEARCH"]));
?>

<section class="wrap result">
	<h1 class="main-title">Результаты поиска</h1>
	<div class="search_box">
	<?php if(count($arResult["SEARCH"]) == 0): ?>
		<p class="nothing">По данному запросу ничего не найдено</p>
	<?php else: ?>
		<?php foreach($arResult["SEARCH"] as $arItem):?>
			<?php 
				$url = $arItem['URL'];
				if(strpos($url, 'services/?sphrase_id') != false)
				{
					$title = 'Услуги';
				}
				else
			...
			<div class="search_item">
				...
				<a target="_blank" class="right_reff" href="<?= $url; ?>">
					<svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M4.95385 46L38.9231 12.0308V42.4615H46V0H3.53846V7.07692H33.9692L0 41.0462L4.95385 46Z" fill="black" fill-opacity="0.7"/>
					</svg>
				</a>
			</div>
		<?php endforeach; ?>
